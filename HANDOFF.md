...
Current release: **0.2.0**. Start with [README](README.md), [release evidence](docs/releases/0.2.0.md), and the canonical [Spellcast Skill](skills/spellcast/SKILL.md).
...
Keep evidence precise: a browser test proves browser behavior; an HTTP MCP round trip proves that adapter; host tool registration and host wakeups need their own evidence. The 0.2.0 notes record what was actually checked.
